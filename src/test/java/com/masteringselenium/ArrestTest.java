...
public class ArrestTest {
	 private WebDriver driver;
	  ...
	  public void setUp() throws Exception {
	    ...
	    baseUrl = "https://arrestinquiryweb.co.mecklenburg.nc.us/";
	    driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
	    driver.get(baseUrl + "/Arrest");
	  }
	  ...
	  public void testAutoSpecLogin() throws Exception {
	    ...
	    wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#divNoResults > div.row > div.col-md-12 > span.alert.alert-default")));
	    assertTrue(driver.findElement(By.cssSelector(".alert.flashStyle ")).getText().startsWith("No results found. Check your spelling or widen your search."));
	  }
